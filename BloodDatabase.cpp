...
// =================== PUNTO 6: SIMULACIÓN DE API DE VALIDACIÓN ===================

// Esta función simula una API para validar teléfonos.
// Acepta solo números de 10 dígitos (formato celular colombiano).
...
void BloodDatabase::getDonorDetails() {
    ...
    newDonor.setNumber(getValidatedInput("Número: "));
...
void BloodDatabase::searchAndDisplay() const {
    ...
    addressFilter = trim(addressFilter); // limpieza
    ...
    bloodTypeFilter = trim(bloodTypeFilter); // limpieza
